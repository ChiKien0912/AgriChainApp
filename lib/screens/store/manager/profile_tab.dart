...
class ProfileTab extends StatefulWidget {
  ...
  const ProfileTab({super.key, required this.branchId});
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 6),
                        Text(widget.branchId, style: const TextStyle(color: Colors.white70, fontSize: 14)),
                      ],
                    ),
                  ],
                ),
                        ...
                        children: [
                          buildManagerTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (_) => EmployeesScreen(branchId: widget.branchId)),
                              );
                            },
                          ),
                          buildManagerTile(
                            icon: Icons.bar_chart,
                            title: "Xem báo cáo chi nhánh",
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (_) => StoreOrderScreen(branchId: widget.branchId)),
                              );
                            },
                          ),
                          buildManagerTile(
